...
import styles from "./KSRequests.module.scss";
import { DashboardCard, Loader, Breadcrumb } from "../../../components";
import { ReactComponent as Dashboard1Icon } from "../../../assests/chart-bar2.svg";
import { useGetListForApprovalQuery } from "../../../api/KisaanStationsApi";
import { NavLink } from "react-router-dom";
import { KSTable, KSTableCard, SideDrawer } from "../../KisaanStation";
...
const KSRequests = () => {
    ...
    let { data, isLoading, isFetching, refetch } =
        useGetListForApprovalQuery(currentPage);
