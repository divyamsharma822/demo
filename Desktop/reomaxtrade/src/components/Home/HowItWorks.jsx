...
import ICON1 from '../../assets/icon-how-it-work-1.svg?react';
import ICON2 from '../../assets/icon-how-it-work-2.svg?react';
import ICON3 from '../../assets/icon-how-it-work-3.svg?react';
        ...
        <section className="relative bg-[#141923]">
            <div className="relative container flex flex-col justify-center items-center gap-4 h-full z-20 my-10">
                ...
                <section className="w-full flex flex-col md:grid md:grid-cols-3 my-10 gap-10">
                    {[
                        [ICON1, 'Download Bitcoin Exchange'],
                        [ICON2, 'Add Coins to Your Exchange'],
                        [ICON3, 'Buy/Sell with Exchange'],
